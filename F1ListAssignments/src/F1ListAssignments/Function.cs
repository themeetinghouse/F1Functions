...
public class Function
{
    ...
    public object? FunctionHandler(InputTest input, ILambdaContext context)
    {
        ...
        restClient.ActivitiesRealm.Assignments.AddParameter("page", input.arguments.page);
        return JsonConvert.DeserializeObject<object>(restClient.ActivitiesRealm.Assignments.List(input.arguments.itemId).JsonResponse);
